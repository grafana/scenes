...
Adhoc filters are very powerful ways to dynamically change the scope (filtering) of queries in your scene view. Unlike variables that usually control a predefined label / dimension with adhoc filters
