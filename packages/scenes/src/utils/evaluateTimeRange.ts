...
export function evaluateTimeRange(
   ...
   * Using dateMath.parse can potentially result in now being calculated using two different timestamps.
   ...
   * the timerange indeterminently alternating between less than or equal to 24h and being greater than 24h.
   */
  return {
