...
import { allActiveAggregationsSetsVariable } from './findActiveAggregationsSetByUid';
...
export class AggregationsSetVariable extends MultiValueVariable<AggregationsSetVariableState> {
  ...
  public constructor(initialState: Partial<AggregationsSetVariableState>) {
    ...
    this.addActivationHandler(() => {
      allActiveAggregationsSetsVariable.add(this);

      return () => allActiveAggregationsSetsVariable.delete(this);
    });
  }
